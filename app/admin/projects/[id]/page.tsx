...
// We only need one wrapper. Let's use this one:
    ...
    <div className="p-8 max-w-[1600px] mx-auto w-full min-h-screen">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-1">
          {/* We set a fixed height here and use flex-col */}
          <div className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50 sticky top-8 h-[650px] flex flex-col overflow-hidden">
