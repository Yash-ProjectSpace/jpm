...
export default function AdminNoticesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({ title: '', category: 'COMPANY', content: '' }); // Reset form
        router.refresh();
      } else {
  ...
  return (
    <div className="p-8 max-w-[1000px] mx-auto w-full min-h-screen">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex justify-end pt-4 border-t border-slate-100">
            <button 
              ...
              className="bg-amber-500 hover:bg-amber-600 text-white font-black py-4 px-10 rounded-2xl shadow-lg shadow-amber-200 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
